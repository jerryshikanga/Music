<script type="text/javascript">
      $(document).ready(function() {
          ...
          $.ajax({
            url : "<?php echo site_url('users/get_user_roles');?>",
            type : "get",
            dataType : "html",
          ...
          $('#usernameInput').keyup(function(){
            $.ajax({
              url : "<?php echo site_url('users/checkUserName');?>",
              ...
              fields: {
                  ...
                  username : {
                      validators:{
                        ...
                        emailAddress : {
                          message : "username must e a valid email address"
                        }
                      }
                  },
                  password: {
...
<form class="form" id="addUserForm">
              <div class="form-group">
                ...
                <div class="col-sm-7">
                  <input type="text" name="name" class="form-control" placeholder="Enter Full name e.g John Doe"/>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3 control-label">Username:</label>
                <div class="col-sm-7">
                  <input type="text" name="username" id="usernameInput" class="form-control" placeholder="Enter username e.g john@doe.com"/>
