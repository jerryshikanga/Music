        ...
        <div class="row">
            <div class="col-md-7">
                <div class="signin-info">
                    ...
                    <div class="mb20"></div>
                    <h5><strong>Welcome to Husseine Empire Management System!</strong></h5>
                    <ul>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Users Management</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Mailing Subcribers Management</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Blog Management</li>
                        <li><i class="fa fa-arrow-circle-o-right mr5"></i> Photo, Video, Audio Management</li>
